...
def parse_args(args):
    ...
    parser.add_argument("--label", type=int, default=0, help="Specify the label to be used for training.")
    ...
    parser.add_argument("--target", type=str, default="noise", help="Generate noise or data.")
    parser.add_argument("--seed", type=int, default=42, help="Random seed for reproducibility.")
    parser.add_argument("--device", type=str, default="cpu", choices=["cpu", "cuda"], help="Device to use.")
    parser.add_argument("--tau", type=int, default=10, help="Number of iterations.")
    parser.add_argument("--ds-size", type=int, default=1000, help="Dataset size.")
...
def test(diff, x_test, first_x):  # [0,255]
    ...
    ssim_values = get_ssim_single(generated_images, real_images, args, gen_img_count=10, real_img_count=20)
...
if __name__ == "__main__":
    ...
    search_space = {
        "lr": tune.loguniform(0.053, 0.054),
        "batch_size": tune.choice([8]),  # 4 8 16
        # "hidden_features": tune.choice([8]),  # 6-10
        "L": tune.choice([9]),  # 6-10
        "N": tune.choice([2]),
