...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=[
            ...
            # ["differN_noise", 8, "9", "2"],
            # ["QDenseUndirected_old_noise", "55", "8"],
    ...
    parser.add_argument(
        "--load-path",
        type=str,
        default="results/formal/emnist_",
    ...
    parser.add_argument("--ds-size", type=int, default=1300, help="Dataset size. 80% is used for training.")
    # 所有预模型学习率
    # u-net
    ...
    # pl
    parser.add_argument("--QIDDM_PL_noise_lr", type=float, default=0.001852, help="Learning rate.")
    # qnn
