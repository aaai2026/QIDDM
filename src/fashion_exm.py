...
def parse_args(args):
    ...
    # 所有预模型学习率
    # u-net
    parser.add_argument("--UNetUndirected_lr", type=float, default=0.0127, help="Learning rate.")
    # differn
    # parser.add_argument("--differN_noise_lr", type=float, default=0.0411, help="Learning rate.")
    parser.add_argument("--differN_noise_lr", type=float, default=0.02615, help="Learning rate.")

    # qdense
    parser.add_argument("--QDenseUndirected_old_noise_lr", type=float, default=0.00723, help="Learning rate.")
    # pl
    parser.add_argument("--QIDDM_PL_noise_lr", type=float, default=0.01295, help="Learning rate.")
    # qnn
    parser.add_argument("--QNN_noise_lr", type=float, default=0.0241, help="Learning rate.")
