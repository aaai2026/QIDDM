...
def parse_args(args):
    ...
    parser.add_argument("--label", type=int, default=21, help="Specify the label to be used for training.")
    ...
    parser.add_argument("--n_classes", type=int, default=26, help="Number of label classes to use.")
    ...
    parser.add_argument("--ds-size", type=int, default=1300, help="Dataset size.")
...
def train_fmnist28(config):
    ...
    # Load dataset
    x_train, y_train, height, width = data.emnist_28x28(n_classes=args.n_classes, ds_size=args.ds_size)
