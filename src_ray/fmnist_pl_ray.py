...
# model
from metrics import *
from nn import QDenseUndirected_old_noise, QNN_A, QNN, differN_noise, QIDDM_PL_noise, UNetUndirected, QIDDM_PL, differN_old_pca
...
def train_with_tune(config):
    ...
    # net = differN_old_pca(8, spectrum_layer=L, N=N).to(args.device, dtype=torch.double)
